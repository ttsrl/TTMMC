...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TTMMC.Models.DBModels.KeepAliveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TTMMC.Models.DBModels.LayoutRecordField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TTMMC.Models.DBModels.Mould", b =>
                {
                    ...
                    b.Property<int?>("DefaultMasterId");
            ...
            modelBuilder.Entity("TTMMC.Models.DBModels.Layout", b =>
                {
                    ...
                    b.HasOne("TTMMC.Models.DBModels.LayoutRecord", "LayoutSetRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("TTMMC.Models.DBModels.LayoutRecordField", b =>
                {
                    b.HasOne("TTMMC.Models.DBModels.LayoutRecord")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("TTMMC.Models.DBModels.Mould", b =>
                {
                    ...
                    b.HasOne("TTMMC.Models.DBModels.Master", "DefaultMaster")
                        .WithMany()
                        .HasForeignKey("DefaultMasterId");
